...
_TOOL_CATEGORIES_BASE = [
    ...
    # =========================================================================
    {
        ...
        'tools': [
            {'slug': 'resume-builder', 'name': 'Resume Builder', 'short_desc': 'Build a professional resume with live preview and PDF export.', 'icon': 'bi-file-person', 'template_name': 'tools/resume/resume-builder.html', 'tags': 'resume,cv,build,career', 'order': 1, 'is_active': True},
