...
_TOOL_CATEGORIES_BASE = [
    ...
    # =========================================================================
    {
        ...
        'tools': [
            ...
            {'slug': 'code-debugger', 'name': 'AI Code Debugger', 'short_desc': 'Debug and fix code errors using AI assistance.', 'icon': 'bi-bug', 'template_name': 'ai_tools/detail.html', 'tags': 'code,debug,fix,ai,developer', 'order': 36, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'sql-generator', 'name': 'AI SQL Generator', 'short_desc': 'Generate SQL queries from plain English descriptions.', 'icon': 'bi-database-gear', 'template_name': 'ai_tools/detail.html', 'tags': 'sql,generate,query,ai,developer', 'order': 37, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'sql-query-generator', 'name': 'SQL Query Generator', 'short_desc': 'Generate complex SQL queries using AI.', 'icon': 'bi-database', 'template_name': 'ai_tools/detail.html', 'tags': 'sql,query,generate,ai,developer', 'order': 38, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'regex-generator', 'name': 'AI Regex Generator', 'short_desc': 'Generate regular expressions from plain text descriptions.', 'icon': 'bi-regex', 'template_name': 'ai_tools/detail.html', 'tags': 'regex,generate,pattern,ai,developer', 'order': 39, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'html-minifier', 'name': 'AI HTML Minifier', 'short_desc': 'Minify HTML code with AI-assisted optimization.', 'icon': 'bi-filetype-html', 'template_name': 'ai_tools/detail.html', 'tags': 'html,minify,compress,ai,developer', 'order': 40, 'is_active': True, 'is_ai_powered': True},
        ],
    },
    ...
    # =========================================================================
    {
        ...
        'tools': [
            ...
            {'slug': 'notes-generator', 'name': 'AI Notes Generator', 'short_desc': 'Generate structured study notes from any topic or text using AI.', 'icon': 'bi-journal-plus', 'template_name': 'ai_tools/detail.html', 'tags': 'notes,generate,ai,student,study', 'order': 23, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'quiz-generator', 'name': 'AI Quiz Generator', 'short_desc': 'Generate quiz questions and answers from any subject using AI.', 'icon': 'bi-patch-question', 'template_name': 'ai_tools/detail.html', 'tags': 'quiz,generate,ai,student,test', 'order': 24, 'is_active': True, 'is_ai_powered': True},
        ],
    },
    ...
    # =========================================================================
    {
        ...
        'tools': [
            ...
            {'slug': 'ai-humanizer', 'name': 'AI Humanizer', 'short_desc': 'Make AI-generated text sound natural and human-written.', 'icon': 'bi-person-hearts', 'template_name': 'ai_tools/detail.html', 'tags': 'ai,humanize,rewrite,writing,ai', 'order': 21, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'essay-writer', 'name': 'AI Essay Writer', 'short_desc': 'Generate complete essays on any topic using AI.', 'icon': 'bi-journal-text', 'template_name': 'ai_tools/detail.html', 'tags': 'essay,write,ai,writing,generate', 'order': 22, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'paraphrasing-tool', 'name': 'AI Paraphrasing Tool', 'short_desc': 'Rewrite and paraphrase text using AI to avoid plagiarism.', 'icon': 'bi-arrow-repeat', 'template_name': 'ai_tools/detail.html', 'tags': 'paraphrase,rewrite,ai,writing,plagiarism', 'order': 23, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'grammar-checker', 'name': 'AI Grammar Checker', 'short_desc': 'Check and correct grammar, spelling and punctuation using AI.', 'icon': 'bi-check2-all', 'template_name': 'ai_tools/detail.html', 'tags': 'grammar,check,spelling,ai,writing', 'order': 24, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'email-writer', 'name': 'AI Email Writer', 'short_desc': 'Write professional emails in seconds using AI.', 'icon': 'bi-envelope-open', 'template_name': 'ai_tools/detail.html', 'tags': 'email,write,ai,writing,professional', 'order': 25, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'cold-email-generator', 'name': 'Cold Email Generator', 'short_desc': 'Generate high-converting cold emails for outreach campaigns.', 'icon': 'bi-envelope-plus', 'template_name': 'ai_tools/detail.html', 'tags': 'cold,email,generate,outreach,ai', 'order': 26, 'is_active': True, 'is_ai_powered': True},
        ],
    },
    ...
    # =========================================================================
    {
        ...
        'tools': [
            ...
            # ── AI-powered creator/social tools ──
            {'slug': 'instagram-caption-generator', 'name': 'Instagram Caption Generator', 'short_desc': 'Generate engaging Instagram captions for any post using AI.', 'icon': 'bi-instagram', 'template_name': 'ai_tools/detail.html', 'tags': 'instagram,caption,generate,ai,social', 'order': 15, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'tweet-generator', 'name': 'AI Tweet Generator', 'short_desc': 'Generate engaging tweets and Twitter/X posts using AI.', 'icon': 'bi-twitter-x', 'template_name': 'ai_tools/detail.html', 'tags': 'tweet,twitter,generate,ai,social', 'order': 16, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'youtube-script-generator', 'name': 'YouTube Script Generator', 'short_desc': 'Generate full YouTube video scripts using AI.', 'icon': 'bi-youtube', 'template_name': 'ai_tools/detail.html', 'tags': 'youtube,script,generate,ai,creator', 'order': 17, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'youtube-title-generator', 'name': 'YouTube Title Generator', 'short_desc': 'Generate click-worthy YouTube video titles using AI.', 'icon': 'bi-play-btn', 'template_name': 'ai_tools/detail.html', 'tags': 'youtube,title,generate,ai,creator', 'order': 18, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'thumbnail-prompt-generator', 'name': 'Thumbnail Prompt Generator', 'short_desc': 'Generate AI image prompts for YouTube thumbnails.', 'icon': 'bi-image', 'template_name': 'ai_tools/detail.html', 'tags': 'thumbnail,prompt,generate,ai,creator', 'order': 19, 'is_active': True, 'is_ai_powered': True},
        ],
    },
    ...
    # =========================================================================
    {
        ...
        'tools': [
            ...
            {'slug': 'blog-writer', 'name': 'AI Blog Writer', 'short_desc': 'Generate full SEO-optimized blog posts using AI.', 'icon': 'bi-newspaper', 'template_name': 'ai_tools/detail.html', 'tags': 'blog,write,seo,ai,content', 'order': 19, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'seo-article-generator', 'name': 'SEO Article Generator', 'short_desc': 'Generate complete SEO articles with headings and keywords.', 'icon': 'bi-file-earmark-richtext', 'template_name': 'ai_tools/detail.html', 'tags': 'seo,article,generate,ai,content', 'order': 20, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'keyword-cluster-generator', 'name': 'Keyword Cluster Generator', 'short_desc': 'Group and cluster keywords by topic using AI.', 'icon': 'bi-diagram-3', 'template_name': 'ai_tools/detail.html', 'tags': 'keyword,cluster,seo,ai,group', 'order': 21, 'is_active': True, 'is_ai_powered': True},
        ],
    },
    ...
    # =========================================================================
    {
        ...
        'tools': [
            {'slug': 'ai-resume-builder', 'name': 'AI Resume Builder', 'short_desc': 'Build a professional resume with AI.', 'icon': 'bi-file-person', 'template_name': 'ai_tools/detail.html', 'tags': 'resume,cv,build,career,ai', 'order': 1, 'is_active': True, 'is_ai_powered': True},


            {'slug': 'ai-ats-resume-checker', 'name': 'AI ATS Resume Checker', 'short_desc': 'Check if your resume is ATS-friendly with AI.', 'icon': 'bi-check-circle', 'template_name': 'ai_tools/detail.html', 'tags': 'ats,resume,check,career,ai', 'order': 2, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'ai-cover-letter-generator', 'name': 'AI Cover Letter Generator', 'short_desc': 'Generate a professional cover letter with AI.', 'icon': 'bi-envelope-paper', 'template_name': 'ai_tools/detail.html', 'tags': 'cover,letter,build,career,ai', 'order': 3, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'ai-linkedin-headline-generator', 'name': 'AI LinkedIn Headline Generator', 'short_desc': 'Generate a LinkedIn headline with AI.', 'icon': 'bi-linkedin', 'template_name': 'ai_tools/detail.html', 'tags': 'linkedin,headline,generate,career,ai', 'order': 4, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'ai-linkedin-post-generator', 'name': 'AI LinkedIn Post Generator', 'short_desc': 'Generate a LinkedIn post with AI.', 'icon': 'bi-linkedin', 'template_name': 'ai_tools/detail.html', 'tags': 'linkedin,post,generate,career,ai', 'order': 5, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'cover-letter-generator', 'name': 'Cover Letter Generator', 'short_desc': 'Generate a tailored cover letter with AI for any job application.', 'icon': 'bi-envelope-open-heart', 'template_name': 'ai_tools/detail.html', 'tags': 'cover,letter,generate,ai,career', 'order': 5, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'linkedin-post-generator', 'name': 'LinkedIn Post Generator', 'short_desc': 'Generate engaging LinkedIn posts for any topic using AI.', 'icon': 'bi-linkedin', 'template_name': 'ai_tools/detail.html', 'tags': 'linkedin,post,generate,ai,career', 'order': 5, 'is_active': True, 'is_ai_powered': True},
    ...
    # =========================================================================
    {
        ...
        'tools': [
            ...
            {'slug': 'startup-name-generator', 'name': 'AI Startup Name Generator', 'short_desc': 'Generate creative startup names and brand ideas using AI.', 'icon': 'bi-stars', 'template_name': 'ai_tools/detail.html', 'tags': 'startup,name,generate,ai,business', 'order': 19, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'business-plan-generator', 'name': 'AI Business Plan Generator', 'short_desc': 'Generate a comprehensive business plan outline using AI.', 'icon': 'bi-briefcase', 'template_name': 'ai_tools/detail.html', 'tags': 'business,plan,generate,ai,startup', 'order': 20, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'logo-prompt-generator', 'name': 'Logo Prompt Generator', 'short_desc': 'Generate AI image prompts for logo design and branding.', 'icon': 'bi-palette', 'template_name': 'ai_tools/detail.html', 'tags': 'logo,prompt,generate,ai,brand', 'order': 21, 'is_active': True, 'is_ai_powered': True},
            {'slug': 'image-prompt-generator', 'name': 'Image Prompt Generator', 'short_desc': 'Generate creative AI image prompts for any concept or scene.', 'icon': 'bi-image-alt', 'template_name': 'ai_tools/detail.html', 'tags': 'image,prompt,generate,ai,art', 'order': 22, 'is_active': True, 'is_ai_powered': True},
