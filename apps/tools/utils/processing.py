...
import mimetypes
from apps.core.utils import validate_mime, MIME_TO_TYPE, safe_filename
...
class FileProcessor:
    ...
    def get_file_info(file_obj: UploadedFile) -> Dict[str, Any]:
        ...
        _, detected_mime = validate_mime(file_obj, None)
        return {
            'name': file_obj.name,
            'size': file_obj.size,
            ...
            'mime_type': detected_mime if file_obj.size > 0 else 'unknown'
        }
