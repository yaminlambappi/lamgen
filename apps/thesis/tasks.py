...
from apps.core.utils import _get_redis_client
...
def process_thesis_task(self, thesis_id: int) -> None:
    ...
    from apps.thesis.services.llm_service import LLMService, LLMServiceError
    from apps.thesis.services.pdf_service import PDFService
    from apps.thesis.services.thesis_pdf import ThesisPDFGenerator, ThesisPDFGeneratorError
