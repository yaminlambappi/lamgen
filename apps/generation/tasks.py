...
def run_generation_pipeline(job_id: str) -> None:
    ...
    try:
        if job.input_file:
            try:
                from apps.generation.services.document_parser import DocumentParserService
                import mimetypes
    ...
    # ------------------------------------------------------------------
    try:
        from apps.generation.services.outline_generator import OutlineGenerationService
...
def continue_generation_pipeline(job_id: str) -> None:
    ...
    # ------------------------------------------------------------------
    try:
        from apps.generation.services.section_generator import SectionGenerationService
